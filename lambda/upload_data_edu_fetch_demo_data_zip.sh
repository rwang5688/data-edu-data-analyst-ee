...
rm -rf ./data_edu_fetch_demo_data_zip && mkdir data_edu_fetch_demo_data_zip
cp -r ./data_edu_fetch_demo_data/* ./data_edu_fetch_demo_data_zip
cd ./data_edu_fetch_demo_data_zip
